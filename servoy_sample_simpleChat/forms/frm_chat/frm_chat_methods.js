...
if(globals.chatMsg)
{
	...
	else
	{
		if(globals.lastChatUserIP != globals.toIP)
		{
			...
			globals.recieved = '<html><table border=0 width=100%><tr bgcolor=#666666><td><font color=#ffffff>' +
				'Started conversation with ' + gchattouserid_to_chat_users.user_name + ' at ' + 
				utils.dateFormat(new Date(), 'HH:mm') + '</font></td></tr></table><br>' + globals.recieved
	...
	globals.recieved = '<html><font color="' + fontColor + '">' + localUser +' - ' + utils.dateFormat(new Date(), 'HH:mm') + ': ' + msg + '</font><br>' + globals.recieved
}
